...
import { loadWeatherData, loadedWeatherData } from 'models/weather-data';
...
const WeatherInfo = ({
  ...
  const handleSubmit = e => {
    e.preventDefault();
    loadWeatherData(inputs.weather);
  };
...
export default withModelProps({ loadedWeatherData, loadWeatherData })(
  WeatherInfo,
);
